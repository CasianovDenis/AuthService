...
namespace Myproject.Base.Services.HttpTrace
{
    public class HttpTrace : EventListener
    {
        /*public HttpTrace(string conf)
        {

        }*/
        class HttpEvent : Microsoft.AspNetCore.Mvc.Controller
        {
        ...
        protected override void OnEventSourceCreated(EventSource eventSource)
        {
            ...
            // var m = new HttpContext.User.Claims.ToList();
